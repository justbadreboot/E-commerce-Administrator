      ...
      {isOpen && (
        <div className="fixed  inset-x-0  pb-6 sm:inset-3 sm:p-0 sm:flex z-50 h-gl">
          <div className="inset-0 transition-opacity">
            ...
            <div className="relative pb-5 bg-white  rounded-lg pt-3  mx-auto my-auto  ">
              ...
              <div className="max-auto">
                <div className='mx-auto z-50'>
                  <div className="p-3 h-2gl  mx-auto my-auto bg-white rounded-lg ">
                      ...
                      <table className="w-full text-left table-collapse">
                        <tbody>
                          <tr className="bg-gray-100 p-3">
                            <td className="font-medium p-3 pt-0 text-center"><strong>Número de Factura: </strong></td>
                            <td className="text-center p-3 pt-0 font-light"> {products.number}</td>

                          </tr>
                          <tr className="bg-gray-100 p-3">
                            <td className="font-medium p-3 pt-0 text-center"><strong>Fecha de Factura: </strong></td>
                            <td className="text-center p-3 pt-0 font-light">{products.date}</td>

                          </tr>

                          <tr className="bg-gray-100 p-3">
                            <td className="font-medium p-3 pt-0 text-center"><strong>Cédula del Cliente:</strong></td>
                            <td className="text-center p-3 pt-0 font-light">{products.customerDocument}</td>
                          </tr>
                          <tr className="bg-gray-100">
                            <td className="font-medium p-3 pt-0 text-center"><strong>Telefono del cliente:</strong></td>
                            <td className="text-center p-3 pt-0 font-light">{products.customerPhone}</td>
                          </tr>
                          <tr className="bg-gray-100">
                            <td className="font-medium p-3 pt-0 text-center"><strong>Cliente:</strong></td>
                            <td className="text-center p-3 pt-0 font-light">{products.customerName} {products.customerLastName}</td>
                          </tr>
                        </tbody>
                      </table>
                      <tbody className=''>

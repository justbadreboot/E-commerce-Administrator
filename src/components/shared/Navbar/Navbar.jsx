...
const Navbar = () => {
    ...
    return (
        <div className='max-w-20 inset-y-0 my-4 ml-0 block   overflow-y rounded-2xl border-0 bg-gray-50 p-0  shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent'>
            <div>
